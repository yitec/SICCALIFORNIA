...
$sql="select resultado,observaciones_analista,observaciones_gerente from tbl_resultados where consecutivo_solicitud='".$_REQUEST['consecutivo']."' and analisis_padre=70";
...
<div align="center" class="titulo_sombreado" style="margin-bottom:10px; margin-top:10px;">ANÁLISIS ANTICARDIOLIPINAS IGG</div>
<div align="left">
...
<tbody>
        ...
        <td valign="top" class="Arial14Negro"><input id="txt_unidades_igg" class="inputbox" type="text" value="" /></td>                        
...
<div align="center" class="titulo_sombreado" style="margin-bottom:10px; margin-top:10px;">ANÁLISIS ANTICARDIOLIPINAS IGM</div>
<div align="left">
<table class="margen_izquierdo">
<tbody>
        <tr>
        ...
        <td valign="center" class="Arial14Negro"><input id="txt_unidades_igm" class="inputbox" type="text" value="" /></td>                        
...
<input id="btn_aprobarrescardio" type="submit" value="Guardar" name="submit" class="submit" />
