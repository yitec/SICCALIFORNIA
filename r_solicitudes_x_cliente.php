...
<div  class="titulo_anaranjado" ><div class="texto_anaranjado"  >Solicitudes del cliente: <?=$_REQUEST['cliente']?></div></div>
...
$sql="select id from tbl_clientes where nombre='".$_REQUEST['cliente']."'";
$result=mysql_query($sql);
$row=mysql_fetch_object($result);

$sql="select consecutivo,monto_total,fecha_terminado from tbl_solicitudes where id_cliente='".$row->id."'";
