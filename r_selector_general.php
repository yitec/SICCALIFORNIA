...
{  
    echo'<tr>
        ...
        <td class="datos_tablas"><div align="center"><a class="Texto14negro" id="ver" href="r_status_contrato.php?solicitud='.$row->consecutivo.'&cliente='.$row->nombre.'&fecha='.fecha_nacional($row->fecha_ingreso).'"><img src="img/search.png" width="25" height="25" /></a></div></td>
    </tr>';  
}
?>
</tbody>
