...
$sql="select id from tbl_analisis where id_analisis>=239 and id_analisis<=247 and consecutivo_solicitud='".$_REQUEST['consecutivo']."'";
$result=mysql_query($sql);
while($row=mysql_fetch_object($result)){
        if($v_ids=='') {
                $v_ids=$row->id;
...
<tbody>
        ...
        <td valign="center" class="Arial14Negro"><input id="txt_unidades_glucoso3" class="inputbox" type="text" value="" /></td>                        
...
<input id="btn_guardarrescurva3" type="submit" value="Guardar" name="submit" class="submit" />
</div>    
<br>
