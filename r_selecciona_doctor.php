...
<div class="titulo"><span id="texto_titulo_panel" >Reportes del Sistema</span></div>
...
<br>
<div class="Arial14Negro" align="center">Doctor</div>
<div class="ui-widget" align="center" ><input class="inputboxPequeno" size="50" id="txt_buscardoc" name="txt_buscardoc" type="text"  /></div>
    

	
	<div align="center" style="margin-top:0px; margin-bottom:0px;"><input id="btn_generardoc" type="submit" value="Generar" name="submit" class="submit" /></div>    
...
<script type="text/javascript">
	var availableTags=busca_doctores();	
</script>
