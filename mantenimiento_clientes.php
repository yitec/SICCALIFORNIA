...
<div class="Arial14Negro" style="margin-left:450px; float:left; margin-top:5px;   ">Cliente:</div>
	...
	<table>
	  ...
	  <tr>
	    <td class="Arial14Negro">Edad</td>
	    
	    </tr>
	  <tr>
	    <td class="Arial14Negro">Año<input id="txt_fax" class="inputbox" size="10" type="text" /></td>
	    <td class="Arial14Negro">Mes<input id="txt_fax" class="inputbox" size="10"type="text" /></td>
	    <td class="Arial14Negro">Días<input id="txt_fax" class="inputbox" size="10" type="text" /></td>
