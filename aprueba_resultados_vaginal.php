...
<tbody>
        ...
        <tr>
        <td class="Arial14Negro"><textarea class="textArea" id="txt_gram" cols="45" rows="3"><?=$v_resultados[1];?></textarea></td>
        </tr>
</tbody>        
</table>
<table class="margen_izquierdo">
<tbody>
        ...
        <tr>
        <td class="Arial14Negro"><textarea class="textArea" id="txt_cultivo" cols="45" rows="3"><?=$v_resultados[2];?></textarea></td>
        </tr>
</tbody>        
</table>
<table class=" margen_izquierdo">
...
<input id="btn_aprobarresvag" type="submit" value="Guardar" name="submit" class="submit" />
