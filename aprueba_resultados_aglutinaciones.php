...
<input id="txt_padre" type="hidden" value="68" />
<?
//busco si es un resultado rechazado y si es así imprimo los valores anteriores
$sql="select resultado,observaciones_analista,observaciones_gerente from tbl_resultados where consecutivo_solicitud='".$_REQUEST['consecutivo']."' and analisis_padre=68";
...
<tbody>
        ...
        <input id="txt_resultado_salo" class="inputbox" type="text" value="<?=$v_resultados[0];?>" /></td>        
...
<tbody>
        ...
        <tr>
        <td class="Arial14Negro" valign="center">        
        <input id="txt_resultado_salh" class="inputbox" type="text" value="<?=$v_resultados[1];?>" /></td>        
...
<tbody>
        ...
        <tr>
        <td class="Arial14Negro" valign="center">        
        <input id="txt_resultado_salah" class="inputbox" type="text" value="<?=$v_resultados[2]?>" /></td>        
...
<tbody>
        ...
        <tr>
        <td class="Arial14Negro" valign="center">        
        <input id="txt_resultado_salbh" class="inputbox" type="text" value="<?=$v_resultados[3]?>" /></td>        
...
<tbody>
        ...
        <tr>
        <td class="Arial14Negro" valign="center">        
        <input id="txt_resultado_salbru" class="inputbox" type="text" value="<?=$v_resultados[4]?>" /></td>        
...
<tbody>
        ...
        <tr>
        <td class="Arial14Negro" valign="center">        
        <input id="txt_resultado_salpro" class="inputbox" type="text" value="<?=$v_resultados[5]?>" /></td>        
...
<input id="btn_aprobarresagluti" type="submit" value="Guardar" name="submit" class="submit" />
