...
<input id="txt_padre" type="hidden" value="17" />
<?
...
<tbody>
        ...
        <td valign="center" class="Arial14Negro"><input id="txt_unidades_glucoso2" class="inputbox" type="text" value="mg/dl" /></td>                        
...
<input id="btn_aprobarrescurva2" type="submit" value="Guardar" name="submit" class="submit" />
