...
if ($_REQUEST['tubo_sumerhill']!=''){
	$_SESSION['sumerhill']=1;
}else{
	$_SESSION['sumerhill']=0;
}
$_SESSION['tubo_sumerhill']=$_REQUEST['tubo_sumerhill'];
$_SESSION['tubo_escalante']=$_REQUEST['tubo_escalante'];
/**********Calcula la edad*********
