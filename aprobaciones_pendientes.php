    ...
    echo'<tr>
        ...
        <td class="datos_tablas Texto14rojo">'.fecha_nacional($row->fecha_solicitud).'</td>';
         if($row->id_analisis==1){
            ...
            echo '<td class="datos_tablas"><div align="center"><a id="ver" href="aprueba_resultados_vaginal.php?id='.$row->id.'&consecutivo='.$row->consecutivo_solicitud.'&nombre='.utf8_encode($row->nombre).'&unidades='.$row->unidades.'"><img src="img/check.png" width="25" height="25" /></a></div></td>';                        
